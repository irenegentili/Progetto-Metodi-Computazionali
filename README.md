...
Questo secondo script è diviso in tre parti. In tutte e tre si fanno varie simulazioni per ogni coppia energia-angolo, di cui poi si calcola media e deviazione standard della media del numero delle particelle
rivelate per ogni coppia. Inoltre si riportano per ogni coppia il valore medio e la devizione standard della media  e un istogramma riportante la distribuzione del numero di particelle rivelate.
Infine nella prima si realizzano in un'unica figura un istogramma 3D rappresentante il numero medio di particelle rivelate in funzione dell'energia 
